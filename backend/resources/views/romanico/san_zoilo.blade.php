...
<head>
  ...
  <title>Monasterio de San Zoilo — Románico Palentino</title>
...
<body>
  ...
  <main class="ficha-content">
    ...
    <div class="ficha-section">
      ...
      <div class="imagen-principal">
        <img id="imagen-grande"
             src="{{ asset('romanico/images/monasteriosanzoilo01.jpg') }}"
             alt="Vista del Monasterio de San Zoilo">
      </div>
    </div>
    ...
    <div class="ficha-section">
      <h2>Galería</h2>
      <div class="galeria">
        <img src="{{ asset('romanico/images/monasteriosanzoilo01.jpg') }}" alt="Monasterio de San Zoilo — vista 1" onclick="cambiarImagen(this)">
        <img src="{{ asset('romanico/images/monasteriosanzoilo02.jpg') }}" alt="Monasterio de San Zoilo — vista 2" onclick="cambiarImagen(this)">
        <img src="{{ asset('romanico/images/monasteriosanzoilo03.jpg') }}" alt="Monasterio de San Zoilo — vista 3" onclick="cambiarImagen(this)">
      </div>
    </div>

    <div class="ficha-section">
      <h2>Audioguía</h2>
      <audio controls src="{{ asset('romanico/audios/audioguia_monasterio_de_san_zoilo.mp3') }}">
        Tu navegador no soporta el elemento de audio.
      </audio>
      <img class="qr"
           src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data={{ url('/romanico/audios/audioguia_monasterio_de_san_zoilo.mp3') }}"
           alt="Código QR para la audioguía del Monasterio de San Zoilo">
    </div>
