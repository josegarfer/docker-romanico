...
<head>
  ...
  <title>Iglesia de Santiago — Románico Palentino</title>
...
<body>
  ...
  <main class="ficha-content">
    ...
    <div class="ficha-section">
      ...
      <div class="imagen-principal">
        <img id="imagen-grande"
             src="{{ asset('romanico/images/iglesiasantiago01.jpg') }}"
             alt="Vista de la Iglesia de Santiago">
      </div>
    </div>
    ...
    <div class="ficha-section">
      <h2>Galería</h2>
      <div class="galeria">
        <img src="{{ asset('romanico/images/iglesiasantiago01.jpg') }}" alt="Iglesia de Santiago — vista 1" onclick="cambiarImagen(this)">
        <img src="{{ asset('romanico/images/iglesiasantiago02.jpg') }}" alt="Iglesia de Santiago — vista 2" onclick="cambiarImagen(this)">
        <img src="{{ asset('romanico/images/iglesiasantiago03.jpg') }}" alt="Iglesia de Santiago — vista 3" onclick="cambiarImagen(this)">
      </div>
    </div>

    <div class="ficha-section">
      <h2>Audioguía</h2>
      <audio controls src="{{ asset('romanico/audios/audioguia_iglesia_de_santiago.mp3') }}">
        Tu navegador no soporta el elemento de audio.
      </audio>
      <img class="qr"
           src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data={{ url('/romanico/audios/audioguia_iglesia_de_santiago.mp3') }}"
           alt="Código QR para la audioguía de la Iglesia de Santiago">
    </div>
