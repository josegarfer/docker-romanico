...
<head>
  ...
  <title>Iglesia de Santa María del Camino — Románico Palentino</title>
...
<body>
  ...
  <header class="ficha-header">
    <h1>Iglesia de Santa María del Camino</h1>
  </header>
  ...
  <main class="ficha-content">
    ...
    <div class="ficha-section">
      ...
      <div class="imagen-principal">
        <img id="imagen-grande"
             src="{{ asset('romanico/images/iglesiasantamaria01.jpg') }}"
             alt="Vista de la Iglesia de Santa María del Camino">
      </div>
    </div>
    ...
    <div class="ficha-section">
      <h2>Galería</h2>
      <div class="galeria">
        <img src="{{ asset('romanico/images/iglesiasantamaria01.jpg') }}" alt="Santa María del Camino — vista 1" onclick="cambiarImagen(this)">
        <img src="{{ asset('romanico/images/iglesiasantamaria02.jpg') }}" alt="Santa María del Camino — vista 2" onclick="cambiarImagen(this)">
        <img src="{{ asset('romanico/images/iglesiasantamaria03.jpg') }}" alt="Santa María del Camino — vista 3" onclick="cambiarImagen(this)">
      </div>
    </div>

    <div class="ficha-section">
      <h2>Audioguía</h2>
      <audio controls src="{{ asset('romanico/audios/audioguia_de_la_iglesia_de_santa_maria_del_camino.mp3') }}">
        Tu navegador no soporta el elemento de audio.
      </audio>
      <img class="qr"
           src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data={{ url('/romanico/audios/audioguia_de_la_iglesia_de_santa_maria_del_camino.mp3') }}"
           alt="Código QR para la audioguía de Santa María del Camino">
    </div>

  </main>

  <footer class="romanico-footer">
    Página creada por &ldquo;El Serrano&rdquo; de Villanueva del Conde (Salamanca)
  </footer>
